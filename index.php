	...
	<body>
		...
		<div class="main">
			...
			<div class="fullcal">
				...
				<p id="about"><strong>About this:</strong> YouTube/Google provide different APIs and you can do any kind of crazy stuff with them, like getting the complete uploads video playlist from any YouTube user, but that is half of work, then you have to present the data in a way it is pleasant to view, I tried many libraries already available online, but none did what I wanted, I tried a time-line, many calendars, but nothing, then I coded a “zooming” calendar, but it didn’t work well on iOS, so following Casey’s philosophy, I keep it as simple as it can be.</p>
